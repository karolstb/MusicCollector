...
namespace MusicCollector.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new MyApplicationUser { UserName = model.Email, Email = model.Email, DataUrodzenia = model.DataUrodzenia };
        ...
        //    {
        //        var user = new MyApplicationUser { UserName = model.Email, Email = model.Email, DataUrodzenia=model.DataUrodzenia };
        //        UserStore<MyApplicationUser> Store = new UserStore<MyApplicationUser>(new MyApplicationDbContext());
